...
from .models import Customer, rej
...
#     class Meta:
#         model = Company
#         fields = ['tin', 'contact_person', 'phone_number']
#
#     def save(self, commit=True):
#         company = super().save(commit=False)
#         company.tin = self.cleaned_data['tin']
#         company.contact_person = self.cleaned_data['contact_person']
